...
const CERTS = [
  ...
  },
  {
    ...
    institution: 'California State University Fullerton, 2024',
  ...
  {
    icon: <FaTerminal />,
    title: 'Master of Science — Computer Science (Artificial Intelligence Track)',
  ...
  {
    icon: <FaCode />,
    title: 'Computing in Python — GTx',
    date: '2020',
    statusLabel: 'Completed',
    statusType: 'completed' as const,
    pdfHref: '/img/certifications/GTx CS1301xI Certificate _ edX.pdf',
    pdfLabel: 'View Certificates',
  },
  {
    icon: <FaCertificate />,
    title: 'SEEQ Data Analytics Engineer',
    date: '2024',
    statusLabel: 'Completed',
    statusType: 'completed' as const,
